...
$(function () {
    ...
    $(".br").click(function () {
        ...
        $("#projeto-willian p").html('Aplicação web e mobile de Willian Metzger, desenvolvida em <span class="texto-destaque">HTML5</span>, <span class="texto-destaque">CSS3</span>, e <span class="texto-destaque">JavaScript</span>. O objetivo do website é expor projetos pessoais e profissionais do desenvolvedor, assim como seus canais de contato. O projeto está em fase final de desenvolvimento.');
